...
public class BlogService implements IBlogService {
    ...
    public Page<Blog> findAll(String name, Pageable pageable) {
        return iBlogRepository.findAllByContentBlogContainingOrderByCreateTimeBlog(name,pageable);
    }
    ...
    public void save(Blog blog) {
       if(blog.getId() == null){
           blog.setCreateTimeBlog(String.valueOf(LocalDateTime.now()));
...
//           blog.setCreateTime(blog.getCreateTime());
    ...
    public List<Blog> findAllByCategoryName(String name) {
        return iBlogRepository.findAllByCategory_Name(name);
    }
